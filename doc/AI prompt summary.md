...
## 10. הכנה להגנה
1. ליצור שאלות שיכולים לשאול אותנו בהגנה.
2. ליצור שאלות לפי מה שרואים בפרויקט בלבד.
3. להכין תשובות קצרות לשאלות קשות.
4. להסביר מה עשינו מאפס עד 100.
5. ליצור reflection בעברית ובאנגלית.
6. לנסח reflection בשלושה שלבים:
 - הרצת הקוד שלהם
 - מימוש הקוד שלנו והשוואה למאמר
 - השיטה שלנו H&T כניסוי/בונוס
7. להסביר מה התפקיד של AI בפרויקט.
8. להסביר מה האדם עשה ומה AI עשה.
9. להכין סיכום אנושי וקצר.
