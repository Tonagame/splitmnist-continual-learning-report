...
## What We Learned About H&T

H&T was strongest in the hardest setting, Class-CL.
...
Fourier and ASW were useful ablations, but they were not the main reason H&T worked.
...
> The project reproduced key Split MNIST trends from the paper and then tested an experimental replay-and-stability method, H&T. The results show that richer replay signals help most when task identity is unavailable.
...
- H&T is an experimental prototype, not a method from the original paper.
...
- test H&T on CIFAR-100 or TinyImageNet,
