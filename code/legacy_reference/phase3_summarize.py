...
METHODS = [
    "None", "EWC", "LwF", "A-GEM", "Separate Networks", "LSR-lite",
    "LSR-lite + Fourier", "LSR-lite + ASW", "LSR-lite + Fourier + ASW", "Joint",
]
...
LOGS = {
    ...
    "LSR-lite": "splitMNIST_task_2000_lsr_lite.log",
    "LSR-lite + Fourier": "splitMNIST_task_2000_lsr_lite_fourier.log",
    "LSR-lite + ASW": "splitMNIST_task_2000_lsr_lite_asw.log",
    "LSR-lite + Fourier + ASW": "splitMNIST_task_2000_lsr_lite_fourier_asw.log",
...
def find_result_files(results):
    return {
        ...
        "LSR-lite": latest(results.glob("acc-splitMNIST5-task--LSR-lite--i2000-b128-bud100-kd1.0-feat1.0.txt")),
        "LSR-lite + Fourier": latest(results.glob("acc-splitMNIST5-task--LSR-lite-Fourier--i2000-b128-bud100-kd1.0-feat1.0-fft0.1.txt")),
        "LSR-lite + ASW": latest(results.glob("acc-splitMNIST5-task--LSR-lite-ASW--i2000-b128-bud100-kd1.0-feat0.5-asw0.5-2.0-eps1e-08.txt")),
        "LSR-lite + Fourier + ASW": latest(results.glob("acc-splitMNIST5-task--LSR-lite-Fourier-ASW--i2000-b128-bud100-kd1.0-feat0.5-fft0.05-asw0.5-2.0-eps1e-08.txt")),
...
def load_asw_stats(results, method):
    pattern = {
        "LSR-lite + ASW": "metrics-splitMNIST5-task--LSR-lite-ASW--i2000-b128-bud100-kd1.0-feat0.5-asw0.5-2.0-eps1e-08.csv",
        "LSR-lite + Fourier + ASW": "metrics-splitMNIST5-task--LSR-lite-Fourier-ASW--i2000-b128-bud100-kd1.0-feat0.5-fft0.05-asw0.5-2.0-eps1e-08.csv",
    }.get(method)
    if not pattern:
        return {}
